...
export const gridItems = [
  {
    id: 1,
    title:
      "As a full-stack blockchain developer, I specialize in creating decentralized applications that redefine user interaction and financial transactions. With expertise in Solidity, Rust, Anchor (solana), React, Nextjs,  JavaScript, and a passion for DeFi, I deliver solutions that are secure, scalable, and aligned with the latest in blockchain innovation.",
    description: "",
